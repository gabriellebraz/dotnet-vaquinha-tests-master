...
namespace Vaquinha.AutomatedUITests
{
	public class DriverFactory
    {
        ...
        public DriverFactory()
        {
            ...
            ChromeDriverService service = ChromeDriverService.CreateDefaultService("/usr/bin");
            // FirefoxDriverService service = FirefoxDriverService.CreateDefaultService("/usr/bin");
